...
##Modeling Process
First I split the dataset into traing and test set with 80:20 allocation. Then using the training set, I came up with the optimal lambda (tuning parameter) which minimize the MSE using he cross-validation method. The best lamda derived is `r best_cv`. and the model estimates are:
```{r}
